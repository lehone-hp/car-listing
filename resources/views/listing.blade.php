                                    ...
                                    <div class="col-12 col-sm-6 col-md-4 col-xl-2">
                                        ...
                                        <div class="form-group">
                                            <select class="form-control rounded" name="budget">
                                                ...
                                                <option value="0,2000000" {{ $search['budget_high'] == 2000000 ? 'selected' : '' }}>0 - 2,000,000</option>
                                                ...
                                                <option value="-1,-1" {{ $search['budget_low'] == -1 ? 'selected' : '' }}>Negotiable</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-6 col-md-4 col-xl-2">
                                    ...
                                    <div class="col-12 col-sm-6 col-md-4 col-xl-2">
                                        ...
                                        <div class="form-group">
                                            <select class="form-control rounded" name="year[]">
                                                ...
                                                @endfor
                                                <option value="1" {{ in_array(1, $search['year']) ? 'selected' : '' }}>below {{ \Carbon\Carbon::now()->year - 19 }}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-6 col-md-4 col-xl-2">
                                ...
                                <div id="demo5" class="collapse show widget-content">
                                    <div class="card-body py-4 bg-white">
                                        <div class="row">
                                            ...
                                            @endfor
                                            <div class="form-group col-4">
                                                <input type="checkbox" name="year[]" {{ in_array(1, $search['year']) ? 'checked' : '' }}
                                                id="year_0" value="0">
